...
class TestAtomicCounterLogic:
    ...
    async def test_last_worker_triggers_merge(self):
        ...
        with patch("collectors.tonitrus.worker.firestore_client.tonitrus_increment_completed",
                   side_effect=fake_increment), \
             patch("collectors.tonitrus.worker.firestore_client.tonitrus_get_counts",
...
class TestDiscoveryHandler:
    ...
    async def test_handler_enqueues_one_task_per_leaf(self):
        ...
        with patch("collectors.tonitrus.discovery._discover_leaf_categories",
                   new=AsyncMock(return_value=leaf_urls)), \
             patch("collectors.tonitrus.discovery.firestore_client.update_job", new=AsyncMock()), \
             patch("collectors.tonitrus.discovery.firestore_client.tonitrus_set_expected",
                   new=AsyncMock()), \
...
class TestMergeHandler:
    ...
    async def test_merge_deduplicates_by_product_code(self):
        ...
        products = [
            {"product_code": "CODE-001", "product_url": "https://t.com/a", "status": "ok",
             "error_message": "", "product_name": "Item A", "category": "", "breadcrumb": "",
             "description": "", "ean_upc": "", "brand": "", "price": 100, "condition": "New",
             "stock": None, "availability": "", "variants": "[]", "input_url": "", "is_cto": False},
            {"product_code": "CODE-001", "product_url": "https://t.com/a-dup", "status": "ok",
             "error_message": "", "product_name": "Item A dup", "category": "", "breadcrumb": "",
             "description": "", "ean_upc": "", "brand": "", "price": 100, "condition": "New",
             "stock": None, "availability": "", "variants": "[]", "input_url": "", "is_cto": False},
            {"product_code": "CODE-002", "product_url": "https://t.com/b", "status": "ok",
             "error_message": "", "product_name": "Item B", "category": "", "breadcrumb": "",
             "description": "", "ean_upc": "", "brand": "", "price": 200, "condition": "New",
             "stock": None, "availability": "", "variants": "[]", "input_url": "", "is_cto": False},
        ]
        ...
        with patch("collectors.tonitrus.merge.firestore_client.tonitrus_read_all_products",
